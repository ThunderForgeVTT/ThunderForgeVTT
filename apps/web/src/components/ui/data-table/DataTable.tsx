 ...
 *
 * The world archive reached the same wall from the other side: a wall of
 * world tiles is pleasant at three and unreadable at thirty, for exactly the
 * reason the provider cards were. It is the second caller, and the reason
 * this lives under `components/ui` rather than under `pages/admin` — the
 * admin pages still import it as `AdminTable`, which is now a name for this
 * component rather than a second implementation of it. One table in the
 * product means a person who has read one has read them all.
 *
