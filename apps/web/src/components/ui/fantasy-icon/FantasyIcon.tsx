...
function iconPath(name: FantasyIconName) {
  switch (name) {
    ...
    case "quill":
      return (
        <path d="M18 4c-4 1-7 4-9 8l-3 8 8-3c4-2 7-5 8-9-1.3-1.7-2.7-3-4-4zM8 16l-1.5 1.5" />
      );
    case "rune":
    ...
    case "settings":
      return (
        <path d="M12 8.5A3.5 3.5 0 1 0 12 15.5 3.5 3.5 0 1 0 12 8.5m0-5 1.2 2.1 2.3.4-.8 2.2 1.5 1.8-1.9 1.3.2 2.3-2.5-.4-2 1.2-1-2.1-2.3-.5.8-2.2L5.9 8.2l2-.8-.1-2.4 2.3.4L12 3.5z" />
      );
    case "shield":
      return <path d="M12 4l7 3v4c0 4.7-2.7 8.2-7 9-4.3-.8-7-4.3-7-9V7l7-3z" />;
    case "skull":
      return (
        <path d="M12 4a6.5 6.5 0 0 0-6.5 6.5c0 2 1 3.6 2.5 4.7V19h2v-2h4v2h2v-3.8c1.5-1.1 2.5-2.7 2.5-4.7A6.5 6.5 0 0 0 12 4zM9 11h.01M15 11h.01" />
      );
    case "spark":
      return (
    ...
    case "torch":
      return (
        <path d="M14 3c.2 2.1-.6 3.8-2.4 5.2-1.5 1.2-2.5 2.6-2.6 4.8h5c.5-1.4 1.6-2.5 2.8-3.7 1.5-1.5 2.4-3.3 2.2-6.3H14zM10 13h4v7h-4z" />
      );
    case "wand":
      return (
        <path d="M5 19L19 5M15 3l.8 2.2L18 6l-2.2.8L15 9l-.8-2.2L12 6l2.2-.8L15 3z" />
      );
    case "worlds":
      return (
        <path d="M12 3a9 9 0 1 0 0 18 9 9 0 1 0 0-18zm0 0c2.3 2.2 3.7 5.2 3.9 9-1.2 3.7-3 6.7-3.9 9-2.3-2.2-3.7-5.2-3.9-9 .2-3.8 1.6-6.8 3.9-9zm-8.4 9h16.8" />
      );
    default:
      return (
        <path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3z" />
