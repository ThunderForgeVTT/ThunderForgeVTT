      ...
      <main className={styles.main}>
        <Container className={styles.chrome}>
          <div className={styles.hero}>
            ...
            <h1>
              Persistent worlds with arcane controls and collaborative
              scenecraft.
            </h1>
            <p>
              The web shell now reads like a guild hall: parchment surfaces,
              gilded controls, and a consistent entrypoint into setup, auth, and
              active worlds.
            </p>
          </div>
