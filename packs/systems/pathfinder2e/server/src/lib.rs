//! Pathfinder Second Edition (Remaster) Server Package
//!
//! Backend implementation for Pathfinder Second Edition (Remaster) (research digest:
//! research/system_pathfinder2e.json). Mirrors packs/systems/dnd5e/server's
...
pub const SYSTEM_ID: &str = "pathfinder2e";
...
inventory::submit! {
    thunderforge_canvas_core::system_contribution::SystemContribution {
        ...
        ..thunderforge_canvas_core::system_contribution::SystemContribution::new("pathfinder2e")
    }
}
...
mod tests {
    ...
    fn test_system_constants() {
        assert_eq!(SYSTEM_ID, "pathfinder2e");
    }
}
