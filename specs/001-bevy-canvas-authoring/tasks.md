...
- [X] T067 [P] Playwright e2e for quickstart Scenario 1 (walls), Scenario 2 (import) and Scenario 4 (shapes). **All three closed as of 2026-09-03.** Scenario 2 was already done and Scenario 1 closed via spec 002 T011-T013; Scenario 4 was the remainder, and spec 002 T016/T017 are now verified green in the sharded sweep (`canvas-authoring.spec.ts:695` and `:758`) after their GPU-contention blocker cleared
