...
- [ ] T051 [US3] Redirect `admin_setup_oauth_callback` (`src/server/src/auth/admin_setup.rs`) to the wizard's second-factor step rather than straight to `return_to` — an administrator provisioned through a provider is still an administrator
