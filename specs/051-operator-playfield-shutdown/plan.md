...
| **IV. ADRs and specs before divergent implementation** | Pass with ADR-100 drafted | Operators gaining a power no world role can override changes an authority boundary. [ADR-100](../../docs/adrs/20260913-100-an_operator_can_pause_a_worlds_play.md) is drafted **Proposed** with this plan and must be accepted before Phase 2 starts. |
