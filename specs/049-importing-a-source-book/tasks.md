...
- [ ] T032 [049-US1] **Deferred to the phase that builds the entry point, deliberately.** 049 FR-028's guard belongs with the route into the importer, and under the merged arc a book is read into the *account's* library — whose page does not exist until phase 13. The review component offers no route to itself, so nothing is currently reachable by anyone; wiring it to the world panel now would be wiring it to the wrong place. Reopen with phase 13
